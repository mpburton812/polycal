...
**Android TWA + widgets:** [android-twa/README.md](android-twa/README.md) — Bubblewrap package `app.polycal` (`npm run twa:ensure`), sideload first; Play listing later. Apple stays on the PWA.
