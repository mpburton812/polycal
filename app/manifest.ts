    ...
    shortcuts: [
      {
        ...
        description: "Open the New Event (natural language) composer",
        url: "/feed?compose=nlp",
        icons: [{ src: "/icons/icon-192.png", sizes: "192x192", type: "image/png" }],
      },
      {
        name: "Legacy New Event",
        short_name: "Legacy Event",
        description: "Open the Legacy New Event (manual) composer",
