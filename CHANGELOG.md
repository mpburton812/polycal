...
- PC-475–PC-480: Android Trusted Web Activity (`app.polycal`) with a home-screen NLP bar that opens New Event (NLP Input) inside the TWA. `/feed?compose=` deep-links, login callback query, Digital Asset Links, PWA shortcuts. Apple PWA unchanged. Play listing deferred. Change control: `2026.08.25a`.
